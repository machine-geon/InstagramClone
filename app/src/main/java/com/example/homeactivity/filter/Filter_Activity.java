...
import com.example.homeactivity.adapter.ViewPagerAdapter;
import com.example.homeactivity.fragment.EditImageFragment;
import com.example.homeactivity.fragment.FiltersListFragment;
import com.example.homeactivity.interfaces.EditImageFragmentListener;
...
public class Filter_Activity extends AppCompatActivity implements FiltersListFragmentListener, EditImageFragmentListener {
    ...
    * */
    ...
    private class CallApi extends AsyncTask<Object, Object, String> {
        ...
        protected void onPostExecute(String res) {
            ...
            //Picasso.with(Filter_Activity.this).load("http://color.photofuneditor.com/output/" + res).into(imageView);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu_filter, menu);
        return true;
    }
